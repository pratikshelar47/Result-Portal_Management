...
public class addResult extends javax.swing.JFrame {
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        try{
            ...
            if(rs.next())
            {
                st.executeUpdate("insert into result(rollno,physics,math,em,os,dbms) values('"+rollNo+"','"+physics+"','"+math+"','"+em+"','"+os+"','"+dbms+"')");
                JOptionPane.showMessageDialog(null, "Result added for student of Roll No"+rollNo);
            }else{
